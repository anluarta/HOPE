...
namespace Hope.Beta
{
    class Produto_b : Controle.Produto_abs
    {
        ...
        {
            for (int i = 0; i < Hope_c.localSet.Produto.Count; i++)
            {
                HopeDataSet.ProdutoRow produtoRow = Hope_c.localSet.Produto.Rows[i] as HopeDataSet.ProdutoRow;
        ...
        {
            HopeDataSet.ProdutoRow produtoRow = Hope_c.localSet.Produto.NewProdutoRow();
            ...
            Hope_c.localSet.Produto.Rows.Add(produtoRow);
            Hope_c.informacao.Add("000", ListMsg.msg001);
            return true;
        }

        protected override bool select_all_from_registro(out Entidade.IProduto_Ent_c[] produto_Ents)
        {
            if (Hope_c.localSet.Produto.Count != 0)
            {
                ...
                for (int i = 0; i < Hope_c.localSet.Produto.Count; i++)
                {
                    ...
                    {
                        _ID_Produto = (int)Hope_c.localSet.Produto.Rows[i]
                        [Hope_c.localSet.Produto.Columns.IndexOf("ID_Produto")],
                        _EAN = Hope_c.localSet.Produto.Rows[i]
                        [Hope_c.localSet.Produto.Columns.IndexOf("EAN")].ToString(),
                        _Descricao = Hope_c.localSet.Produto.Rows[i]
                        [Hope_c.localSet.Produto.Columns.IndexOf("Descricao")].ToString(),
                        _Unidade = Hope_c.localSet.Produto.Rows[i]
                        [Hope_c.localSet.Produto.Columns.IndexOf("Unidade")].ToString(),
                        _Custo = (decimal)Hope_c.localSet.Produto.Rows[i]
                        [Hope_c.localSet.Produto.Columns.IndexOf("Custo")],
                        _Venda = (decimal)Hope_c.localSet.Produto.Rows[i]
                        [Hope_c.localSet.Produto.Columns.IndexOf("Venda")]
                    });
                }
            ...
            else
            {
                ...
                Hope_c.informacao.Add("000", "Tabela vazia");
                return false;
            }
        }
    }
