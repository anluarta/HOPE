...
namespace Hope
{
    public abstract class Hope_c : IHope
    {
       protected BackOffice BackOffice;
       protected Pos Pos;
       
        Interface.IBackOffice IHope.BackOffice => BackOffice;

        Interface.IPos IHope.Pos => Pos;
        Interface.IAutenticacao IHope.Autenticacao => Hope_static.Autenticacao;
        ...
        //IProduto_c IHope_v.Produto { get => produto; }
        //ICaixa_c IHope_v.Caixa { get => caixa; }
        //IVender_c IHope_v.Vender { get => vender; }
        ...
        //IColaborador_c IHope_v.Colaborador => colaborador;

        //IComprador_c IHope_v.Comprador => comprador;
    }
}
