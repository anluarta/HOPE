    ...
    abstract class Caixa_abs : ICaixa_c
    {
            ...
            if (meucaixaaberto())
            {
                switch (SituacaoCaixa)
                {
                    ...
                    case ListEnum.TipoSituacaoCaixa.FaltaFechar:
                        Hope.informacao.Add("000", "Caixa com fechamento pedente");
                        return false;
                    default:
                        Hope.informacao.Add("000", "erro na situacao caixa");
                        return false;
                }
            }
        ...
        internal void Logouf()
        {
            if (SituacaoCaixa == ListEnum.TipoSituacaoCaixa.Aberto)
            {
                ...
                {
                    Hope.informacao.Add("000", "Erro ao gravar dados de saido do colaborado no logouf");
        ...
        internal bool pagamento()
        {
            ...
            _MeuCaixa.total_Ent_Abs._Cupom_Vendido = decimal.Add(_MeuCaixa.total_Ent_Abs._Cupom_Vendido, Hope.vender._Pagar._NovoRegistro._Cobrado);
            _MeuCaixa.total_Ent_Abs._Recebimento = decimal.Add(_MeuCaixa.total_Ent_Abs._Recebimento, Hope.vender._Pagar._NovoRegistro._Recebido);
            _MeuCaixa.total_Ent_Abs._Cheque = decimal.Add(_MeuCaixa.total_Ent_Abs._Cheque, Hope.vender._Pagar._NovoRegistro._Cheque);
            _MeuCaixa.total_Ent_Abs._Credito = decimal.Add(_MeuCaixa.total_Ent_Abs._Credito, Hope.vender._Pagar._NovoRegistro._Credito);
            _MeuCaixa.total_Ent_Abs._Debito = decimal.Add(_MeuCaixa.total_Ent_Abs._Debito, Hope.vender._Pagar._NovoRegistro._Debito);
            _MeuCaixa.total_Ent_Abs._Dinheiro = decimal.Add(_MeuCaixa.total_Ent_Abs._Dinheiro, Hope.vender._Pagar._NovoRegistro._Dinheiro);
            _MeuCaixa.total_Ent_Abs._Interno = decimal.Add(_MeuCaixa.total_Ent_Abs._Interno, Hope.vender._Pagar._NovoRegistro._Interno);
            _MeuCaixa.total_Ent_Abs._Outro = decimal.Add(_MeuCaixa.total_Ent_Abs._Outro, Hope.vender._Pagar._NovoRegistro._Outro);
            _MeuCaixa.total_Ent_Abs._Vale_Alimentacao = decimal.Add(_MeuCaixa.total_Ent_Abs._Vale_Alimentacao, Hope.vender._Pagar._NovoRegistro._Vale_Alimentacao);
            _MeuCaixa.total_Ent_Abs._Vale_Refeicao = decimal.Add(_MeuCaixa.total_Ent_Abs._Vale_Refeicao, Hope.vender._Pagar._NovoRegistro._Vale_Refeicao);
            _MeuCaixa.total_Ent_Abs._Desconto = decimal.Add(_MeuCaixa.total_Ent_Abs._Desconto, Hope.vender._Pagar._NovoRegistro._Desconto);
            _MeuCaixa.total_Ent_Abs._Troco = decimal.Add(_MeuCaixa.total_Ent_Abs._Troco, Hope.vender._Pagar._NovoRegistro._Troco);
        ...
        IInformacao_c ICaixa_c.Informacao => Hope.informacao;
        ...
        bool ICaixa_c.Reforco(decimal _Valor, string _Observacao)
        {
            if (Hope.colaborador.Autenticado)
            {
                ...
                {
                    Hope.informacao.Add("000", "Seu caixa nao ta aberto");
